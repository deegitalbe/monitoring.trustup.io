    ...
    @if ($health_check)
        <div class="w-full bg-white p-6">
            <div class="mb-4 flex justify-end space-x-2">
                ...
                <a href="{{ route('end-points.show', ['end_point' => $endPoint, 'health_check' => request()->health_check, 'date_range' => 'w']) }}" class="{{ request()->date_range == 'w' ? 'bg-gray-400' : 'bg-gray-200' }} hover:bg-gray-400 transition-colors py-2 px-4 rounded">Last week</a>
                <a href="{{ route('end-points.show', ['end_point' => $endPoint, 'health_check' => request()->health_check, 'date_range' => '2w']) }}" class="{{ request()->date_range == '2w' ? 'bg-gray-400' : 'bg-gray-200' }} hover:bg-gray-400 transition-colors py-2 px-4 rounded">Last 2 weeks</a>
                ...
                <a href="{{ route('end-points.show', ['end_point' => $endPoint, 'health_check' => request()->health_check, 'date_range' => '3m']) }}" class="{{ request()->date_range == '3m' ? 'bg-gray-400' : 'bg-gray-200' }} hover:bg-gray-400 transition-colors py-2 px-4 rounded">Last 3 months</a>
